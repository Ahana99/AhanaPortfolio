            ...
            <div className="shadow-lg p-10 rounded-xl my-10 w-1/3">
              ...
              <ul className="py-4">
                <li className="text-gray-800 py-1 dark:text-white">
                  - Underwent training on React and Angular
                </li>
                <li className="text-gray-800 py-1 dark:text-white">
                ...
                <li className="text-gray-800 py-1 dark:text-white">
                  - Developed apps using Angular 13 concepts for client and as a part of a team, implementing
                  API calls, working with models, modules, directives, BehaviourSubject, conditional rendering and reactive forms
                </li>
                <li className="text-gray-800 py-1 dark:text-white">
